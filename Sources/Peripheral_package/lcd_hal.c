...
void lcd_writeName(void){
	//lcd_sendCommand(CMD_CLEAR);
	lcd_setCursor(0,0);
	lcd_writeString("Fredy 146111");
	lcd_setCursor(1,0);
	lcd_writeString("Paulo 147607");
	util_genDelay1ms();
	util_genDelay1ms();
	util_genDelay1ms();
	util_genDelay1ms();
